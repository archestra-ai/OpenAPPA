...
/// A runtime/store invariant prevented the agent from driving the requested root turn.
#[derive(Debug, Error)]
pub enum AgentError {
...
/// A serial agent harness over the runtime mediator and one concrete provider.
pub struct Agent {
