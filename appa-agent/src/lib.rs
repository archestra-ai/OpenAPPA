...
//!
//! The provider performs inference only. [`Agent`] rebuilds every request from the runtime-owned
//! trajectory and delegates every proposed flow back to the runtime for mediation.
