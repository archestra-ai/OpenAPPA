...
//! its authority's mandate** and **every gap is covered**. Rulings are bound to the exact
//! `DispatchId` — call-scoped and single-use (a repeat call is a new occurrence and takes a fresh
//! ruling).
//!
...
pub(crate) fn execute_remedy_plan(
    ...
    // within its authority's mandate.
    for ruling in rulings {
