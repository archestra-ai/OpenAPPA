...
//!
//! The runtime is the sole source of truth for a session (CC2): it holds the trajectory and rebuilds
...
mod tests {
    ...
    fn rejects_inbound_assistant_and_tool_history() {
        // A harness cannot replay assistant/tool turns — that channel is exactly what the confining
        // executor removes.
