...
impl Runtime {
    ...
    pub async fn execute_remedy(&self, acting: &Actor, offer: OfferId) -> RemedyOutcome {
        self.remedy(acting, offer, RemedyArguments::default(), None).await
    }
    ...
    pub async fn execute_remedy_with(
        ...
        self.remedy(acting, offer, arguments, None).await
    }
}
...
impl Runtime {
    ...
    pub(crate) async fn remedy(
        ...
        match session.on_remedy(offer, arguments, elicitation).await {
