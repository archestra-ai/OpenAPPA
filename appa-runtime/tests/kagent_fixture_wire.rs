...
//!
//! `marketplace/plugins/kagent/fixtures/wire-events.jsonl` is the one sample of the
...
const FIXTURES: &str = include_str!("../../marketplace/plugins/kagent/fixtures/wire-events.jsonl");
