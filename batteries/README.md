...
| --- | --- | --- |
| `claude-code/` | `Bash`, `Read`, and every tool the policy does not name in a Claude Code session | The Claude Code model classifies Bash calls and the requirements of undeclared tools; `read-sensitivity.py` labels file contents |
