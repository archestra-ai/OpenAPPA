...
pub mod plan;
pub mod projection;
// Crate-internal reusable label algebras: a consumer composes the built-in
// dimensions, never the raw presets.
...
// sink, remediation, transformers, or waivers. Plan/remedy internals
// (`RemedyPlan`, `PlannedRemedy`, `NonEmptyVec`, id newtypes, the authority
// view types) stay reachable through their modules — they are read off
// returned values, never constructed by a consumer.
