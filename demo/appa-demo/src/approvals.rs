...
/// How long a parked ruling waits for the visitor before abstaining. Kept
/// under the resolver timeout the service configures, so the answer is always
/// ours and never a transport fault.
pub const DECISION_WINDOW: Duration = Duration::from_secs(55);
