...
- If you run as a subagent, your final message is checked when you stop, and a blocked stop means you must return a message the policy allows to cross, not retry the same one.
