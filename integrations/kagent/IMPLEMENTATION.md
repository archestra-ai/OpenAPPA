...
- The shared fixture [fixtures/wire-events.jsonl](fixtures/wire-events.jsonl) pins the wire. The python plugin and the Go plugin both read it, and both build every row from their own wire module.
