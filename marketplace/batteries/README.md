...
| `archestra/` | Archestra's built-in sharing tools (13 tools, 31 rules): projects, apps, knowledge bases and connectors, plugins, agents, MCP gateways, team membership | the `archestra` audience source: organization members, a team, one member |
