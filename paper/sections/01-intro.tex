...
An LLM agent with tools operates as a confused deputy in the textbook sense~\cite{hardy1988confused}:
...
model hallucinations, ambiguous instructions, or miscalibrated agent reasoning~\cite{ji2023survey}.
