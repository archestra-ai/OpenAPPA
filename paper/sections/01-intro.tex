...
guardrails---such as prompt-injection classifiers, regex filters, and output hygiene rules---judge
...
isolated bug rather than a symptom of mixed-confidentiality processing. On the
other hand, static structural restrictions---such as allowlists, mandatory human approval,
and policies disabling tool use after reading untrusted data---judge \emph{structure}.
However, they do so statically and coarsely, imposing operational overhead on benign
actions and severely degrading agent utility.
