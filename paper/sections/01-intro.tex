...
An LLM agent with tools operates as a confused deputy in the textbook sense~\cite{}:
...
guardrails---such as prompt-injection classifiers, regex filters, and output hygiene rules~\cite{}---judge
...
isolated bug rather than a symptom of mixed-confidentiality processing~\cite{}. On the
other hand, static structural restrictions---such as allowlists, mandatory human approval,
and policies disabling tool use after reading untrusted data~\cite{}---judge \emph{structure}.
However, they do so statically and coarsely, imposing operational overhead on benign
actions and severely degrading agent utility~\cite{}.
