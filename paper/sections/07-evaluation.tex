...
\begin{enumerate}
  ...
  \item \textbf{\appa{}-no-fork:} The identical \appa{} binary and policy executed with \nolinkurl{--max-forks 0}.
...
\multirow{5}{*}{\shortstack[l]{Gemini 3.5\\Flash-Lite}}
 ...
 & \appa{}-nofork  & 11/39 (28\%) & 0/42 (0\%)  & 32 \\
...
\multirow{5}{*}{GPT-5.6 Luna}
 ...
 & \appa{}-nofork  & 27/39 (69\%) & 0/42 (0\%)  & 34 \\
...
\multirow{5}{*}{GPT-4o}
 ...
 & \appa{}-nofork  & 23/39 (59\%) & 3/42 (7\%)  & 38 \\
...
\multirow{5}{*}{Qwen 3.6 35B}
 ...
 & \appa{}-nofork  & 21/39 (54\%) & 1/42 (2\%)  & 34 \\
