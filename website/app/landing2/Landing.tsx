    ...
    <div className="appa-landing" style={S.root}>
      ...
      <main style={S.main}>
        ...
        <div id="demo" style={S.section}>
          ...
          >
            <span style={{ display: "block", fontSize: 17, color: "var(--text-strong)" }}>
              Chat with OpenAPPA →
            </span>
            <span style={{ display: "block", marginTop: "0.5rem", fontSize: 13.5, color: "var(--text-weak)" }}>
              A live agent on the full loop — bring an OpenRouter key, edit the policy, watch every tool call get
              mediated.
            </span>
          </a>
        </div>
