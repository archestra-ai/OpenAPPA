...
const ARMS: Arm[] = [
  {
    ...
    attacksLabel: "0%",
    completion: 82.0,
    completionLabel: "82.0%",
    detail: "0 of 100 attacks succeeded · 82 of 100 tasks completed",
  },
  {
    name: "Unprotected",
    attacks: 29.0,
    attacksLabel: "29.0%",
    completion: 84.0,
    completionLabel: "84.0%",
    detail: "29 of 100 attacks succeeded · 84 of 100 tasks completed",
  },
  {
    ...
    attacksLabel: "29.0%",
    completion: 30.0,
    completionLabel: "30.0%",
    detail: "29 of 100 attacks succeeded · 30 of 100 tasks completed",
  },
];
