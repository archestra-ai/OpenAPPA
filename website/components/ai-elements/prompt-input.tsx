...
export const PromptInputActionAddAttachments = ({
  ...
  const handleSelect = useCallback<NonNullable<ComponentProps<typeof DropdownMenuItem>["onSelect"]>>(
    (e) => {
      e.preventDefault();
...
// base-nova's HoverCard (base-ui PreviewCard) has no open/close delay props;
// the registry code targeted the radix-era wrapper.
