...
OpenAPPA is cross-platform. A single configuration ([Policy configuration](/contracts) describes the format) can be applied at different levels, on different stacks, and by different roles.
