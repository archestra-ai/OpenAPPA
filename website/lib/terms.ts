...
const TERMS = {
  ...
  "[externals.<kind>.<name>]":
    "One deployment binding: a registered authority, sanitizer, cast, or membership resolver bound to exactly one of url, command, or builtin, or a dynamic resolver without a declared builtin bound to url or command. A registered name without a binding, or a binding without a registration, is a load error.",
  declaration:
