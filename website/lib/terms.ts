...
const TERMS = {
  ...
  "[externals.dynamic.<name>]":
    "The deployment binding for one dynamic resolver. It selects an HTTP endpoint, in-process builtin, or local command. Command execution is not available in this build, so a command binding returns no answer.",
  internal:
